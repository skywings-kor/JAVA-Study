...
//선문대학교 컴퓨터공학부 2019243064 박규민
//2022-10-09(일)제작 시작
//2022-10-12(수) 일부 기능 수정
//2022-10-13(목) 최종 제작 완료

//<개발 목적>
//학생 명단 리스트를 JTable을 이용하여 개발함으로써 JTable에 대한 이해도와
//각종 이벤트 코드로 각 기능이 어떻게 작동하는지 파악
//또한 명단 리스트를 개발함으로써 향후 데이터 베이스에서 명단을 불러와서
//적용하는 것까지 이를 바탕으로 진행하면 될 것으로 기대
